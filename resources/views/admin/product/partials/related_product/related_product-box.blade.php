<div class='col mx-5'>
    ...
    <input id="related_id" name="related_id" type="number" class='bg-white-50 border border-opacity-25 border-black rounded-2 px-2 w-10 form-label' placeholder="{{ $relatedProduct->pivot->related_product_id }}" value={{ $relatedProduct->pivot->related_product_id || old('related_id') }}>
