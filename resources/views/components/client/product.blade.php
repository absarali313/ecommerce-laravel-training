...
<div class="col-md-3 mb-4">
    <div class="card shadow-sm h-100">
        ...
        <div class="card-body text-center">
            <a href="{{ url("/product/{$product['id']}") }}" class="text-black text-decoration-none"><h5 class="card-title mb-2">{{$product->title}}</h5></a>

            <div class="d-flex flex-row ms-5">
                <p class="card-text fs-6 text-primary text-black mb-0 mt-2">Rs.{{$product->smallest_price->price}}.00 PKR</p>
                <a href="#" class="btn btn-primary bg-black border-dark ms-5 me-0">CART</a>
            </div>
              </div>
    </div>
</div>
