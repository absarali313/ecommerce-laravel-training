    ...
    <div class="row my-2 border border-1 border-white border-top-0 border-start-0 border-end-0 py-3 mt-2 mb-2">
        <div class="col-10 align-content-center">
            <div class="col">
                ...
                <input id="size_title" name="size_title" class="bg-white-50 border border-opacity-25 border-black rounded-2 px-2 w-10" style="width:100px" placeholder="Small" value= {{ $productSize->title }}>

                <x-form-error name="size_title" />

                <label for="price" class="mx-2 text-start text-secondary">Price</label>
                <input id="price" name="price" type="number" class="bg-white-50 border border-opacity-25 border-black rounded-2 px-2 w-10" style="width:100px" placeholder="Rs. 1000" value= {{ $productSize->getCurrentPrice()->price?? 0 }}>

                <x-form-error name="price" />

                <label for="stock" class="mx-2 text-start text-secondary">Stock</label>
                <input id="stock" name="stock" type="number" class="bg-white-50 border border-opacity-25 border-black rounded-2 px-2 w-10" style="width:100px" placeholder="Small" value= {{ $productSize->stock }}>
