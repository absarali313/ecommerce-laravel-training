    ...
    <div class="row my-2 border border-1 border-white border-top-0 border-start-0 border-end-0 py-3 mt-2 mb-2">
        <div class="col-10 align-content-center">
            <div class="col">
                ...
                <input id="size_title" name="size_title" class="bg-white-50 border border-opacity-25 border-black rounded-2 px-2 w-10" style="width:200px" placeholder="Small" value= {{$productSize->title}}>
